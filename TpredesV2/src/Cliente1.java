...
public class Cliente1 {
    ...
    private static void enviarArchivo(Scanner scanner) {
        System.out.print("IP de Cliente2 (o localhost): ");
        String ipCliente2 = scanner.nextLine().trim();
        if (ipCliente2.isEmpty()) ipCliente2 = "localhost";
        ...
        try (Socket socket = new Socket(ipCliente2, 9002);  // Puerto de Cliente2
             DataOutputStream salida = new DataOutputStream(socket.getOutputStream());
             FileInputStream archivoEntrada = new FileInputStream(archivo)) {

            System.out.println("Conectado a Cliente2, enviando: " + nombreArchivo);
            ...
            System.out.println("Archivo enviado correctamente a Cliente2");

        } catch (IOException e) {
            System.err.println("Error enviando archivo: " + e.getMessage());
            System.err.println("Verifica que Cliente2 este ejecutandose");
        }
    }
